...
public sealed class ConfigurationSetup : IConfigurationSetup
{
    ...
    /// <param name="serviceParameters">The base parameters for the services.</param>
    ...
    public string GetConnectionString(string databaseAlias)
    {
        ...
        var connStr = _databaseSetup.UseIntegratedSecurity
        ...
        if (_databaseSetup.TrustServerCertificate)

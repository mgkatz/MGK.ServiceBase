...
public interface IDbServerSetup
{
    ...
    /// <summary>
    /// Gets if the server certificate should be trusted. This should be always false, except on local environments for testing because enabling this feature the connection process skips the trust chain validation.
    /// </summary>

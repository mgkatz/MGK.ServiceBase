...
public static class AppInitializer
{
	...
	private static string FileConfig
		=> $"Configuration/appsettings{(EnvName is null ? string.Empty : $".{EnvName}")}.json";
	...
	/// </summary>
	public static string EnvName => Environment.GetEnvironmentVariable(ApplicationConstants.EnvironmentName) ?? string.Empty;
